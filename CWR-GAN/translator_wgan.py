...
def _get_longest_length(*args): return max(map(len, args))
...
class TranslatorWGAN(object):
    ...
    def summarize_losses(self, training_stage, return_loss=None, time_delta=None, step_label=''):
        ...
        for batch_start in xrange(0, self.maximal_train_samples, self.batch_size):
            num_train_batches += 1
            sum_dict(
        ...
        for batch_start in xrange(0, self.maximal_dev_samples, self.batch_size):
            num_dev_batches += 1
            sum_dict(
    ...
    def train_till_stop(
        ...
        for epoch in xrange(start_epoch_cnt, max_epochs):
            loss = train_fn()
    ...
    def train(self):
        for stage in xrange(self.training_stages):
